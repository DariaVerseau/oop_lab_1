...
public class Discipline
{
    ...
    public void InputDataDiscipline(Discipline? discipline)
    {
        ...
        if (discipline != null)
        {
            ...
            //Console.WriteLine($"Lecturer id: {teacher.Id}");
            Console.WriteLine("Enter id teacher: ");
            Guid lecturerId = Guid.Parse(Console.ReadLine());
            Teacher = Teacher.SearchLecturer(lecturerId);
        }
    }
    ...
    {
        Console.WriteLine($"Discipline Id: {DisciplineId}");
        Console.WriteLine($"Discipline Name: {DisciplineName}");
        Console.WriteLine($"Discipline description: {DisciplineDiscription}");
        Console.WriteLine($"Teacher: {Teacher.LastName + Teacher.FirstName + Teacher.MiddleName}\n");
    }
}  