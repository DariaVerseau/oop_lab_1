...
//группы
Group g1 = new() { GroupName = "ТСО-105Б-24" };
Group g2 = new() { GroupName = "ТСО-205Б-23" };
Group g3 = new() { GroupName = "ТСО-305Б-22" };
Group g4 = new() { GroupName = "ТСО-405Б-21" };

//добавление студента в группу 
g1.addStudentToGroup(s1);
g1.addStudentToGroup(s5);
g1.addStudentToGroup(s9);
g2.addStudentToGroup(s2);
g2.addStudentToGroup(s6);
g2.addStudentToGroup(s10);
g3.addStudentToGroup(s3);
g3.addStudentToGroup(s7);
g4.addStudentToGroup(s4);
g4.addStudentToGroup(s8);
 ...
 case 1:
     ...
     while (!exitNestedSwitch)
     {
         ...
         Console.WriteLine("0 - back to menu" +
                           ...
                           "\n4 - delete student" +
                           "\n5 - print list" +
                           "\n6 - print group of student");
         int inputSt = int.Parse(Console.ReadLine());
         switch (inputSt)
         {
             case 0:
                 exitNestedSwitch = true;
                 break;
             case 1: 
     ...
     while (!exitNestedSwitch)
     {
         ...
         switch (inputLc)
         {
             ...
             case 1: 
                 ...
                 break;
             case 2:
                 Console.WriteLine("Enter lecturer id for update data:");
                 ...
                 break;
             case 3:
                 Console.WriteLine("Enter lecturer id for searching:");
                 ...
                 break;
             case 4:
                 Console.WriteLine("Enter lecturer id for delete:");
     ...
     {  
         ...
         switch (inputDs)
         {
             ...
             case 1:
                 ...
                 break;
             case 2:
                 Console.WriteLine("Enter discipline id for update data:");
                 ...
                 break;
             case 3:
                 Console.WriteLine("Enter discipline id for searching:");
                 ...
                 break;
             case 4:
                 Console.WriteLine("Enter discipline id for delete:");
     ...
     while (!exitNestedSwitch)
     {
         ...
         switch (inputCr)
         {
             ...
             case 3:
                 ...
                 break;
             case 4:
                 Console.WriteLine("Enter course id for delete:");
